        ...
        <form action="{{ route('admin.apartments.update', $apartment->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="title" class="form-control @error('title') is-invalid @enderror" name="title" id="title"
                    placeholder="p. es. Villa Heraclea" aria-describedby="titlehelp"
                    value="{{ old('title', $apartment->title) }}" required minlength="5">
            ...
            <div class="mb-3">
                ...
                <input type="number" min="1" class="form-control @error('rooms') is-invalid @enderror"
                    placeholder="p. es. 3" name="rooms" id="rooms" aria-describedby="roomshelp"
                    value="{{ old('rooms', $apartment->rooms) }}" required pattern="1" max="100"
            ...
            <div class="mb-3">
                ...
                <input type="number" min="1" class="form-control @error('beds') is-invalid @enderror" name="beds"
                    placeholder="p. es. 2" id="beds" aria-describedby="bedshelp"
                    value="{{ old('beds', $apartment->beds) }}" required pattern="1" max="100"
                    oninput="this.value = Math.abs(this.value)">
            ...
            <div class="mb-3">
                ...
                <input type="number" min="1" class="form-control @error('bathrooms') is-invalid @enderror"
                    placeholder="p. es. 1" name="bathrooms" id="bathrooms" aria-describedby="bathroomshelp"
                    value="{{ old('bathrooms', $apartment->bathrooms) }}" required pattern="1" max="100"
                    oninput="this.value = Math.abs(this.value)">
            ...
            <div class="mb-3">
                ...
                <input type="number" min="1" max="30000"
                    class="form-control @error('square_meters') is-invalid @enderror" name="square_meters"
                    placeholder="p. es. 120" id="square_meters" aria-describedby="square_metershelp"
            ...
            <div class="mb-3">
                ...
                <input type="address" onkeyup="callAddress()" class="form-control @error('address') is-invalid @enderror"
                    placeholder="p. es. corso Vittorio Emanuele, 335, 93012 Gela CL " name="address" id="address"
                    aria-describedby="addresshelp" value="{{ old('address', $apartment->address) }}">
