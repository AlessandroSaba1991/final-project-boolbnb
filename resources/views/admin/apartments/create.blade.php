    ...
    <form class="container p-5" action="{{route('admin.apartments.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" min="1" class="form-control @error('rooms') is-invalid @enderror"  name="rooms" id="rooms" min="1"
                aria-describedby="roomsHelper" value="{{ old('rooms') }}" placeholder="inserisci il numero delle camere..." required pattern="1" oninput="this.value = Math.abs(this.value)">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="beds" id="beds" min="1"
                ...
                placeholder="inserisci il numero dei posti letto..." required pattern="1" oninput="this.value = Math.abs(this.value)">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('bathrooms') is-invalid @enderror" name="bathrooms" id="bathrooms" min="1"
                aria-describedby="bathroomsHelper" value="{{ old('bathrooms') }}" placeholder="numero di bagni..." required pattern="1" oninput="this.value = Math.abs(this.value)">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('square_meters') is-invalid @enderror" min="1" name="square_meters" id="square_meters"
                ...
                placeholder="inserisci la dimensione dell'immobile..." oninput="this.value = Math.abs(this.value)">
