...
<section class="bg_orange py-4 shadow">
    <div class="container">
        <h2 class="text-white text-uppercase text-center mb-0">i tuoi annunci</h2>
    </div>
</section>
...
@endif
    <div class="container py-5">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xxl-4 gx-3 gy-5">
                ...
                <div class="col">
                    <div class="card position-realtive rounded-3 h-100 shadow bg-body">
                        ...
                        <img src="{{ asset('storage/' . $apartment->cover_image) }}" class="dashboard_card_img img-fluid card-img-top ratio ratio-16x9" 
                            alt="...">
                        @else
                        <img src="https://bitsofco.de/content/images/2018/12/Screenshot-2018-12-16-at-21.06.29.png" class="dashboard_card_img img-fluid card-img-top ratio ratio-16x9"
                            alt="...">
                        @endif
                        <div class="badge position-absolute">
                            @if ($apartment->visible)
                                <span class="bg-success rounded bg-gradient me-2 p-2 fs-6">
                            ...
                            @else
                                <span class="bg-danger rounded bg-gradient p-2 me-2 fs-6">
                            ...
                            @if ($control_sponsorization)
                                <span class="bg-success rounded bg-gradient p-2 fs-6">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between p-0 pt-3">
                            ...
                            <a class="btn btn-primary bg-gradient" href="{{ route('admin.apartments.show', $apartment->id) }}">
                                ...
                                <a class="btn btn-success bg-gradient" href="{{ route('admin.messages.index', $apartment->id) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
                                    <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/>
                                    </svg>
                                </a>
                                <a class="btn btn-warning text-white bg-gradient" href="{{ route('admin.sponsorizations.index', $apartment->id) }}">
