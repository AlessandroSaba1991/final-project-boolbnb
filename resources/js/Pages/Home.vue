<template>
  <div class="container-fluid p-0 container-home">
    ...
    <section class="subscription text-center">
      ...
      <div class="container position-relative pb-3 mb-4" v-if="apartments.length > 0">
        <div class="row gy-3 mb-5 pb-3 show_results">
          ...
          >
            <div
              ...
              "
            >
              <div class="bagde_" v-if="apartment.sponsorizations.length > 0">
                Consigliato
              </div>
              <img
        ...
        <nav
          ...
          class="mt-3 position-absolute bottom-0 start-50 translate-middle-x"
        >
          <ul class="pagination justify-content-center mb-0">
            <li class="page-item" v-if="response_apartments.current_page > 1">
              <a
                class="page_link"
                aria-label="Previous"
                @click="getSponsoredApartments(response_apartments.current_page - 1)"
              >
            ...
            <li
              ...
              :key="page"
            >
              <a class="page_link" @click="getSponsoredApartments(page)">{{ page }}</a>
            </li>
            <li
              class="page-item"
              v-if="
                response_apartments.current_page < response_apartments.last_page
              "
            >
              <a
                class="page_link"
      ...
      <div class="col-12 col-lg-6 col-md-12 col-sm-12 bg_orange">
        ...
        >
          ...
          <p class="text-capitalize text-center p-3">
            Il nostro unico obiettivo è offrire la totale sicurezza nei
            confronti dei clienti <br />
            e fornire la miglior esperienza in base alle proprie esigenze.
            <br />
