<template>
    <div class="container-fluid p-0">
        <div class="row g-0 backimg">
            <div
                class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center align-items-center flex-wrap"
            >
                <div class="text-uppercase text-white p-5 title">
                    team 7 boolbnb
                </div>
            </div>
        ...
        <div class="d-flex justify-content-center pt-5">
            <div class="row g-0 w-100">
                ...
                <div
                    class="col-12 col-lg-6 text-center align-content-center bg_orange"
                >
                    <div class="pt_7 mb-5">
                        <h1 class="text-uppercase text-white font_satisy">
                            why us ?
                        </h1>
                        <p
                            class="text-capitalize mt-5 text-white font_monserrat"
                        >
        ...
        <div class="footer">
            <div class="container p-5">
                <div class="row">
                    <div class="col-4">
                        <h5
                            class="pt-4 text-white text-uppercase font_monserrat"
                        >
                            get socials
                        </h5>
